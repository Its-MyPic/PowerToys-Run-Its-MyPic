...
namespace Community.PowerToys.Run.Plugin.Its_MyPic
{
    ...
    public class SubtitleInfo
    {
        ...
        public string FileName => $"{Season}_{Episode}_{Frame_prefer}.webp";
    ...
    public class Data
    {
        private static readonly int DATA_VERSION = BitConverter.ToInt32(SHA256.HashData(Encoding.UTF8.GetBytes("喜歡星星的是初音吧")), 0);
        ...
        private async Task DownloadImage(SubtitleInfo subtitleData)
        {
            ...
            var url = $"https://mypic.0m0.uk/images/{subtitleData.Season}/{subtitleData.Episode}/{subtitleData.Frame_prefer}.webp";
